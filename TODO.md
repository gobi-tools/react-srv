...
- [ ] remove dependency on "fast-glob"
- [ ] add folder/file exclusion list via regex
- [ ] look at using: https://preactjs.com/
...
- [x] handle various folders when outputting html or js (in case pages have duplicate names)
- [x] implement option to serve data w/o hydration, just HTML, for both static & dynamic rendering
- [x] add syntax highligting to docs
- [x] why do some components have the "home)ico.html" name?

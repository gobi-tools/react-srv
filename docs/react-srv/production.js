  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("main", { children: [
      /* @__PURE__ */ jsxs("section", { children: [
        /* @__PURE__ */ jsx2("h2", { children: "Anatomy of a request" }),
        /* @__PURE__ */ jsx2("p", { children: "Every time this example endpoint is hit ..." }),
        /* @__PURE__ */ jsxs("figure", { children: [
          /* @__PURE__ */ jsx2("pre", { children: /* @__PURE__ */ jsx2("code", { children: `app.get('/', (_, res) => {
  const name = req.query['name'];
  return res.status(200).send(react.render(Page, { name }));
});` }) }),
          /* @__PURE__ */ jsx2("figcaption", { children: "server.ts" })
        ] }),
        /* @__PURE__ */ jsxs("p", { children: [
          "... there's a number of things ",
          PRODUCT_NAME,
          " does inside the ",
          /* @__PURE__ */ jsx2("code", { children: "render" }),
          " method:"
        ] }),
        /* @__PURE__ */ jsxs("ol", { children: [
          /* @__PURE__ */ jsxs("li", { children: [
            "First, it ",
            /* @__PURE__ */ jsx2("a", { href: REACT_RENDER_URL, target: "_blank", children: "creates static markup" }),
            " (that includes initial props)"
          ] }),
          /* @__PURE__ */ jsxs("li", { children: [
            "Then, it creates a ",
            /* @__PURE__ */ jsx2("a", { href: REACT_HYDRATION_URL, target: "_blank", children: "hydration" }),
            " script (for subsequent interactivity)"
          ] })
        ] }),
        /* @__PURE__ */ jsx2("p", { children: "Therefore, at each request, the final payload consists of both HTML and Javascript:" }),
        /* @__PURE__ */ jsxs("figure", { children: [
          /* @__PURE__ */ jsx2("pre", { children: /* @__PURE__ */ jsx2("code", { children: `<html>
  <head><title>Page</title></head>
  <body>...</body>
  <script>... set initial props ...<\/script>
  <script type="module">... hydration script ... <\/script>
</html>` }) }),
          /* @__PURE__ */ jsx2("figcaption", { children: "react.render(Page)" })
        ] }),
        /* @__PURE__ */ jsxs("p", { children: [
          "The static markup is created at runtime from the component - ",
          /* @__PURE__ */ jsx2("code", { children: `<Page/>` }),
          " - itself."
        ] }),
        /* @__PURE__ */ jsxs("p", { children: [
          "The hydration script is also created at runtime by reading the file - ",
          /* @__PURE__ */ jsx2("code", { children: `Page.tsx` }),
          " - from disk."
        ] }),
        /* @__PURE__ */ jsxs("p", { children: [
          ...
          /* @__PURE__ */ jsx2("code", { children: "/src" }),
          " folder. This can be changed by specifying the ",
          /* @__PURE__ */ jsx2("code", { children: "srcPath" }),
          " parameter when initialising the shared object."
        ] }),
        /* @__PURE__ */ jsxs("figure", { children: [
          /* @__PURE__ */ jsx2("pre", { children: /* @__PURE__ */ jsx2("code", { children: `const react = new ReactSrv({
  Document,
  srcPath: './input',
});` }) }),
          /* @__PURE__ */ jsx2("figcaption", { children: "server.ts" })
      ...
      /* @__PURE__ */ jsxs("section", { children: [
        /* @__PURE__ */ jsx2("h2", { children: "Prebundling" }),
        /* @__PURE__ */ jsx2("p", { children: "For a small project or for development, reading from disk might be good enough. It does require the source always be present, however, and it does mean the same code will be compiled over and over again, at each request." }),
        /* @__PURE__ */ jsxs("p", { children: [
          "For production builds, it's always best to ",
          /* @__PURE__ */ jsx2("b", { children: "prebundle" }),
          " all the hydration scripts."
        ] }),
        /* @__PURE__ */ jsxs("p", { children: [
          "You can do so by creating a ",
          /* @__PURE__ */ jsx2("code", { children: "prebundle.ts" }),
          " script:"
        ] }),
        /* @__PURE__ */ jsxs("figure", { children: [
          /* @__PURE__ */ jsx2("pre", { children: /* @__PURE__ */ jsx2("code", { children: `import { react } from '../src/server.ts';
react.prebundle()` }) }),
          /* @__PURE__ */ jsx2("figcaption", { children: "prebundle.ts" })
        ] }),
        /* @__PURE__ */ jsxs("p", { children: [
          "Than you can execute via ",
          /* @__PURE__ */ jsx2("a", { href: TSX_URL, target: "_blank", children: "tsx" }),
          " (",
          /* @__PURE__ */ jsx2("code", { children: "tsx prebundle.ts" }),
          ") or add it to your own build pipeline. When successfull, it will write the compiled ",
          /* @__PURE__ */ jsx2("code", { children: ".js" }),
          " files in ",
          /* @__PURE__ */ jsx2("code", { children: "./public/react-srv" }),
          "."
        ] }),
        /* @__PURE__ */ jsxs("p", { children: [
          "You can control the output path and name with the ",
          /* @__PURE__ */ jsx2("code", { children: "outPath" }),
          " and ",
          /* @__PURE__ */ jsx2("code", { children: "outDir" }),
          " config values:"
        ] }),
  ...
  outDir: 'hydration',  // ./react-srv
          ...
          /* @__PURE__ */ jsx2("figure", { children: "server.ts" })
        ] }),
        /* @__PURE__ */ jsxs("details", { className: "card", children: [
          /* @__PURE__ */ jsx2("summary", { children: "Notes on the output folder" }),
          /* @__PURE__ */ jsx2("p", { children: "The output folder must be statically served or accessible via the internet, otherwise the hydration scripts won't be able to load." }),
          /* @__PURE__ */ jsxs("figure", { children: [
            /* @__PURE__ */ jsx2("pre", { children: /* @__PURE__ */ jsx2("code", { children: `app.use(express.static('public'));` }) }),
            /* @__PURE__ */ jsx2("figcaption", { children: "server.ts" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("section", { children: [
        /* @__PURE__ */ jsx2("h2", { children: "Select environment" }),
        /* @__PURE__ */ jsxs("p", { children: [
          "One final step is to let ",
          PRODUCT_NAME,
          " know when you're running in a test environment and when in a production one. You can use the ",
          /* @__PURE__ */ jsx2("code", { children: "isProd" }),
  ...
  isProd: process.env.NODE_ENV === 'production',
        ...
        /* @__PURE__ */ jsxs("details", { className: "card", children: [
          /* @__PURE__ */ jsx2("summary", { children: "Small optimisation" }),
          /* @__PURE__ */ jsxs("p", { children: [
            "In ",
            /* @__PURE__ */ jsx2("code", { children: "prebundle.ts" }),
            " we've referenced the ",
            /* @__PURE__ */ jsx2("code", { children: "react" }),
            " instance created in ",
            /* @__PURE__ */ jsx2("code", { children: "server.ts" }),
            ". This setup works but can be improved by creating a separate ",
            /* @__PURE__ */ jsx2("code", { children: "react-srv.ts" }),
            " (or any other name) file in which we export the instance by default:"
          ] }),
          /* @__PURE__ */ jsxs("figure", { children: [
            /* @__PURE__ */ jsx2("pre", { children: /* @__PURE__ */ jsx2("code", { children: `export default new ReactSrv({
  Document,
  srcPath: './input',
  outPath: './dist',
  outDir: 'hydration',
  isProd: process.env.NODE_ENV === 'production',
            ...
            /* @__PURE__ */ jsx2("figcaption", { children: "react-srv.ts" })
          ] }),
          /* @__PURE__ */ jsx2("p", { children: "This also avoids having to create duplicate instances (one for the script, one for the server) and to keep them in sync." })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("section", { children: [
        /* @__PURE__ */ jsx2("h2", { children: "Performance" }),
        /* @__PURE__ */ jsxs("p", { children: [
        ...
        /* @__PURE__ */ jsx2("p", { children: "This is still pretty reasonable. The content that weighs the most is the React library itself, which needs to be present on every page for hydration and interactivity to work. But that's only loaded once and then cached locally by the browser." }),
        /* @__PURE__ */ jsxs("p", { children: [
        ...
        /* @__PURE__ */ jsxs("p", { children: [
          ...
          /* @__PURE__ */ jsx2("a", { href: NGINX_URL, target: "_blank", children: "nginx" }),
          " as a reverse proxy)"
        ] }),
        /* @__PURE__ */ jsx2("p", { children: "Finally, React itself, just like in development mode, will be available async and cached by the browser." }),
        /* @__PURE__ */ jsx2("p", { children: "In this way, in production we can squeeze as much performance as we can out of rendering React." })
      ] }),
      /* @__PURE__ */ jsx2("hr", {}),
      /* @__PURE__ */ jsxs("blockquote", { className: "card success", children: [
        ...
        /* @__PURE__ */ jsxs("p", { children: [
          ...
          /* @__PURE__ */ jsx2("a", { href: DEMO_PROD_URL, target: "_blank", children: "here" }),
          "."
        ] })
      ] })
    ] })

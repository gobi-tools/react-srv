  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("main", { children: [
      /* @__PURE__ */ jsxs("section", { children: [
        /* @__PURE__ */ jsx2("h2", { children: "Static site generation (SSG)" }),
        /* @__PURE__ */ jsxs("p", { children: [
          PRODUCT_NAME,
          " can be used for direct static site generation (",
          /* @__PURE__ */ jsx2("a", { href: SSG_URL, target: "_blank", children: "SSG" }),
          "). If you've read the section on ",
          /* @__PURE__ */ jsx2("a", { href: PAGE_PRODUCTION_URL, children: "getting to production" }),
          ", then you're already ninety percent there."
        ] }),
        /* @__PURE__ */ jsxs("p", { children: [
          "What you'll need is to create a new file. You can call it ",
          /* @__PURE__ */ jsx2("code", { children: "prerender.ts" })
        ] }),
        ".",
        /* @__PURE__ */ jsxs("figure", { children: [
          /* @__PURE__ */ jsx2("pre", { children: /* @__PURE__ */ jsx2("code", { children: `import ReactSrv from 'react-srv';
...
react.prerender()` }) }),
          /* @__PURE__ */ jsx2("figcaption", { children: "prerender.ts" })
        ] }),
        /* @__PURE__ */ jsxs("p", { children: [
          "We setup the ",
        ...
        /* @__PURE__ */ jsxs("ul", { children: [
          /* @__PURE__ */ jsx2("li", { children: "Set a custom HTML Document (or use the default one)" }),
          /* @__PURE__ */ jsxs("li", { children: [
            "Tell the library where the source ",
            /* @__PURE__ */ jsx2("code", { children: ".tsx" }),
            " pages are"
          ] }),
          /* @__PURE__ */ jsx2("li", { children: "And where to output the resulting HTML and JS files" })
        ] }),
        /* @__PURE__ */ jsxs("p", { children: [
          "And that's it! All you need to do is run ",
          /* @__PURE__ */ jsx2("code", { children: "tsx prerender.ts" }),
          " to have a full, statically generated, website."
        ] })
      ] }),
      /* @__PURE__ */ jsxs("section", { children: [
        /* @__PURE__ */ jsx2("h2", { children: "Disable hydration" }),
        /* @__PURE__ */ jsx2("p", { children: "Prerendering, by default, generates both HTML and hydration JS. In this way statically generated websites can maintain most of the interactivity provided by React." }),
        /* @__PURE__ */ jsx2("p", { children: "If you don't want interactivity, you can disable hydration altogether:" }),
        /* @__PURE__ */ jsxs("figure", { children: [
...
react.prerender()` }) }),
        ...
        /* @__PURE__ */ jsx2("p", { children: "In this way, only HTML files will be generated. A trully static website!" })
      ] }),
      /* @__PURE__ */ jsx2("hr", {}),
      /* @__PURE__ */ jsxs("blockquote", { className: "card success", children: [
        ...
        /* @__PURE__ */ jsxs("p", { children: [
          ...
          /* @__PURE__ */ jsx2("a", { href: DEMO_STATIC_URL, target: "_blank", children: "here" }),
          "."
        ] })
      ] })
    ] })
